...
Demo GIFs in `docs/img/` are generated by `scripts/generate-demo.js`, which drives [VHS](https://github.com/charmbracelet/vhs) inside the container defined by `demos/Dockerfile`. Tape scripts and the shared keybinding file (`ai-rizz.skbd`) are the source of truth - never hand-edit the GIFs. CI regenerates affected demos on PRs.
